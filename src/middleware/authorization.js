...
var authorization = function (isPublic, allowedRoles) {
    if (isPublic === void 0) { isPublic = true; }
    if (allowedRoles === void 0) { allowedRoles = []; }
    return function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
        var accessKey, currentLoggedInUserRole;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (isPublic) {
                        accessKey = ctx.header['access-key'];
                        if (!accessKey || accessKey !== index_1["default"].apiAccessKeys.app) {
                            throw boom_1.forbidden('error.api_forbidden');
                        }
                    }
                    else {
                        currentLoggedInUserRole = ctx.state.user.roles;
